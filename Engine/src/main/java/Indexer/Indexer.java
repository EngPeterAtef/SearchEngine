...
//                allWords.add( p.stem(element));
//               // allWords.remove(element);
//
//        }
            ...
            while (iter.hasNext())
            {
               allWords2.add(p.stem(iter.next().toString())) ;

            }
            for (String elemett:allWords2)
            {
                writerr.write(elemett+System.lineSeparator());
            }
            ////////////////////////////////////////////
